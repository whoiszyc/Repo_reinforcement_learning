...
- The first piece is from the offical tutorials at [[tensorflow website](https://www.tensorflow.org/tutorials)]. This part is in the folder named "tensorflow_web".
- The second piece is from the resource [[Deep Learning Models](https://github.com/rasbt/deeplearning-models)] at Github. They have both Tensorflow and Pytorch implementation.
